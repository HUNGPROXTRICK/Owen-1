...
"https://i.ibb.co/BHJBfzy/4.jpg",
    ...
    "https://i.ibb.co/Sd30dLy/3.jpg",
     ...
     var callback = () => api.sendMessage({body:`𝑮𝒉𝒆̣̂ 𝒅𝒊́𝒕 𝒃𝒖̛̣ 𝒅𝒂̂𝒚 <𝟑\n𝑺𝒐̂́ 𝒂̉𝒏𝒉: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/gai.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/gai.jpg"));  
